		...
		keydown: function()
		{
			return {
				init: function(e)
				{
					...
					{
                                                if( ($(this.keydown.block).prev().hasClass('reviewbox') || $(this.keydown.block).prev().hasClass('checkbox')) && $(this.keydown.block).text() == ''){
				...
				onBackspaceAndDeleteAfter: function(e)
				{
					...
					setTimeout($.proxy(function()
					{
						...
						this.core.editor().find('*[style]').not('img, #redactor-image-box, #redactor-image-editter, ' +
							'mark, p.quote-origin-redactor, iframe.instagram-media, div.insta-slim, iframe.twitter-iframe, table, td, tr, th, tbody, thead').removeAttr('style');
